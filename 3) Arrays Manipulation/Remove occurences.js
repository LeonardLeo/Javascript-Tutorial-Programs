...
function removeOccurrences(array, num) {
    if (array.includes(num)){
        ...
        console.log(`The number ${num}, is not in the array`)
    }
}


test = removeOccurrences([1,2,3,4,4,4,4,4,4,5,6,7,8,9,1,1,1,1], 1)

// NOTE: .SPLICE works best counting BACKWARDS. Always remember.